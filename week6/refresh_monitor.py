...
df_final_with_features = df_final_with_status \
    .join(house_features, on="Booking_ID", how="left")

df_final_with_features = df_final_with_features.withColumn("avg_price_per_room", F.col("avg_price_per_room").cast("double"))
